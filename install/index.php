...
$requirements = [
    "PHP 8.0 or above" => PHP_VERSION_ID > 80000,
    ...
    <div class="register-box-body">
        ...
        <div id="step-2" hidden>
            <form id="install" method="post">
                ...
                <div class="form-group has-feedback">
                    <label for="firebaseServerKeyInput" class="pull-apart">
                        <?= __("firebase_server_key") ?>
                        <a href="https://smsgateway.rbsoft.org/docs/getting_server_key_and_sender_id_from_firebase.htm"
                           target="_blank"><?= __("how_to_get_it") ?></a>
                    </label>
                    <textarea name="firebaseServerKey" id="firebaseServerKeyInput" class="form-control"
                              placeholder="<?= __("firebase_server_key") ?>" rows="5" required="required"></textarea>
                    <span class="fa fa-cloud form-control-feedback"></span>
                </div>
                <div class="form-group has-feedback">
                    <label for="firebaseSenderIdInput" class="pull-apart">
                        <?= __("firebase_sender_id") ?>
                        <a href="https://smsgateway.rbsoft.org/docs/getting_server_key_and_sender_id_from_firebase.htm"
                           target="_blank"><?= __("how_to_get_it") ?></a>
                    </label>
                    <input type="text" name="firebaseSenderId" id="firebaseSenderIdInput" class="form-control"
