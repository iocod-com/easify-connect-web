        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-dismissible bg-primary" id="alert-send-message" style="display: none">
                    ...
                    <p>You can send a mass MMS by separating the mobile numbers using pipe(|) symbol instead of comma(,). It will send an MMS to multiple numbers, like BCC functionality in email. For example, consider the following numbers.</p>
                    ...
                    <p>This will only work if you network operator supports mass MMS.</p>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-dismissible bg-primary" id="alert-send-multiple-messages" style="display: none">
                    ...
                    <h4><i class="icon fa fa-info"></i>&nbsp;Info</h4>
                    <p>You can send a mass MMS by separating the mobile numbers using pipe(|) and entering it in first column. It will send an MMS to multiple numbers, like BCC functionality in email.</p>
                    <p>You can download example Excel file <a href="Example-MMS.xlsx">here</a>.</p>
                    <p>It will send three messages if you use example Excel file provided above. First message will be a mass message to +11234567890,+12345678901 and +13456789012.</p>
                    <p>This will only work if you network operator supports mass MMS.</p>
                </div>
                <!-- general form elements -->
                <div class="box box-primary">
